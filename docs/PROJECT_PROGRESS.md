...
| 包 | GitHub Issue | 内容（对应工程方案界面） | 依赖 |
|----|-------------|------------------------|------|
| **Pkg 1** 🔑 | [#21](https://github.com/YansongG-HKU/EnviroEquipmentFinalEdition/issues/21) | WPF 外壳 + 多设备总览 + 单设备详情 | 无（关键路径） |
| Pkg 2 | [#22](https://github.com/YansongG-HKU/EnviroEquipmentFinalEdition/issues/22) | 报警中心（当前/历史/弹出/toast） | Pkg 1 M1.3 |
| Pkg 3 | [#19](https://github.com/YansongG-HKU/EnviroEquipmentFinalEdition/issues/19) | 程序编辑 + 历史回看 + 持久化 | Pkg 1 M1.3 |
| Pkg 4 | [#23](https://github.com/YansongG-HKU/EnviroEquipmentFinalEdition/issues/23) + [#24–31](https://github.com/YansongG-HKU/EnviroEquipmentFinalEdition/issues/24) | 登录/RBAC + LIMS + MQTT + FTP（已拆 8 子 issue） | Pkg 1 M1.3 + Pkg 3 M3.1 |
...
1. **启动 Pkg 1（#21）** —— Phase 2 关键路径，落地后才有图形界面可看
2. Pkg 1 M1.3 合入 main 后，并行启动 Pkg 2（#22）+ Pkg 3（#19）
3. Pkg 3 M3.1 合入后，启动 Pkg 4（#23 + 子 issue）
